...
# 配置参数
data_files = ['f1_normal_algo.txt', 'f2_normal_algo.txt', 'f3_normal_algo.txt']  # 替换为你的实际文件名
colors = ['royalblue', 'darkorange', 'forestgreen']  # 每组数据的颜色
markers = ['o', 's', '^']  # 每组数据的标记样式
labels = ['normal_algo', 'chain_2_algo', 'recursion_algo']  # 图例标签
